...
float deposito(struct ContaBancaria depositoBanco)
{
  ...
  return depositoBanco.saldo;
}

float saque(struct ContaBancaria saqueBanco)
{
...
int main()
{
  ...
  int codigo;
  // float operadorDeposito, operadorSaque, saldoFinal;
  ...
  do
  {
    ...
    {
    case 1:
      /*operadorDeposito = deposito(conta);
       operadorSaque = saque(conta);
       saldoFinal = operadorDeposito + operadorSaque;*/
      deposito(conta);
      printf("\n");
      break;
